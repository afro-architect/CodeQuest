...
// Swap in real text/media/links later â€” structure is ready to use as-is.
...
const LESSON_CONTENT = [
  {
    ...
    cards: [
      { heading: "Course Introduction", videoSrc: "assets/video/placeholder-course-intro.mp4", body: "By the end of this journey you'll have built your own working pages and mini projects â€” not just read about them." },
      { heading: "What You'll Learn", videoSrc: "assets/video/placeholder-course-intro.mp4", body: "By the end of this journey you'll have built your own working pages and mini projects â€” not just read about them." },
      { heading: "Icebreaker", videoSrc: "assets/video/placeholder-course-intro.mp4", body: "By the end of this journey you'll have built your own working pages and mini projects â€” not just read about them." },
      { heading: "Helpful Terms to Know", videoSrc: "assets/video/placeholder-course-intro.mp4", body: "By the end of this journey you'll have built your own working pages and mini projects â€” not just read about them." },
      { heading: "Every Website is a Conversation", videoSrc: "assets/video/placeholder-every-website-is-a-conversation.mp4", body: "Websites are how computers talk to you â€” through text, images, buttons, and links. Every click is you 'talking back.'" },
      ...
      { heading: "Recap", videoSrc: "assets/video/placeholder-course-intro.mp4", body: "By the end of this journey you'll have built your own working pages and mini projects â€” not just read about them." },
      { heading: "What's Next?", videoSrc: "assets/video/placeholder-course-intro.mp4", body: "By the end of this journey you'll have built your own working pages and mini projects â€” not just read about them." },
          ]
  },
  {
    id: "lesson-2",
    ...
    cards: [
      ...
      { heading: "Navigation Bars", videoSrc: "assets/video/placeholder-navigation-bars.mp4", body: "Menus let people move around a site without getting lost â€” like signs pointing to the ramps and rails at a skate park." },
      ...
      { heading: "Responsive Design", videoSrc: "assets/video/placeholder-responsive-design.mp4", body: "A good site looks great on a phone or a laptop â€” adapting to any terrain, just like a good skater." },
      { heading: "Recap", videoSrc: "assets/video/placeholder-course-intro.mp4", body: "By the end of this journey you'll have built your own working pages and mini projects â€” not just read about them." },
      { heading: "What's Next?", videoSrc: "assets/video/placeholder-course-intro.mp4", body: "By the end of this journey you'll have built your own working pages and mini projects â€” not just read about them." },
]
  },
  {
    ...
    cards: [
      ...
      { heading: "Nesting", videoSrc: "assets/video/placeholder-nesting.mp4", body: "Tags can go inside other tags â€” like a burrito wrapped in foil wrapped in a bag." },
  ...
  },
  {
    ...
    cards: [
      ...
      { heading: "Selectors", videoSrc: "assets/video/placeholder-selectors.mp4", body: "You can target elements by tag, class, or id â€” like picking an outfit for everyone vs. picking one just for you." },
      ...
      { heading: "The Box Model", videoSrc: "assets/video/placeholder-the-box-model.mp4", body: "Every element is a box: content, padding, border, margin â€” like layers of packaging around a product." },
  ...
  },
  {
    ...
    cards: [
      ...
      { heading: "Icebreaker", videoSrc: "assets/video/placeholder-course-intro.mp4", body: "By the end of this journey you'll have built your own working pages and mini projects â€” not just read about them." },
      { heading: "Helpful Terms to Know", videoSrc: "assets/video/placeholder-course-intro.mp4", body: "By the end of this journey you'll have built your own working pages and mini projects â€” not just read about them." },
      { heading: "JS = The Controller", videoSrc: "assets/video/placeholder-js-the-controller.mp4", body: "JavaScript makes a page interactive â€” it responds to clicks, typing, and time." },
      ...
      { heading: "Events", videoSrc: "assets/video/placeholder-events.mp4", body: "Clicks, hovers, and form submits are 'events' â€” triggers that make something happen." },
      { heading: "Functions", videoSrc: "assets/video/placeholder-functions.mp4", body: "Functions are reusable blocks of instructions â€” your character's 'combo move' you can call anytime." },
  ...
  },
  {
    ...
    cards: [
      ...
      { heading: "Icebreaker", videoSrc: "assets/video/placeholder-course-intro.mp4", body: "By the end of this journey you'll have built your own working pages and mini projects â€” not just read about them." },
      { heading: "Helpful Terms to Know", videoSrc: "assets/video/placeholder-course-intro.mp4", body: "By the end of this journey you'll have built your own working pages and mini projects â€” not just read about them." },
      { heading: "Python = A New Board", videoSrc: "assets/video/placeholder-python-a-new-board.mp4", body: "Different language, different feel â€” but you're still surfing the same ocean of logic you learned in JS." },
      ...
      { heading: "Where Python Runs", videoSrc: "assets/video/placeholder-where-python-runs.mp4", body: "Not just in browsers â€” scripts, servers, data pipelines, and even physical robots run on Python." },
  ...
  },
  {
    ...
    cards: [
      ...
      { heading: "Icebreaker", videoSrc: "assets/video/placeholder-course-intro.mp4", body: "By the end of this journey you'll have built your own working pages and mini projects â€” not just read about them." },
      { heading: "Helpful Terms to Know", videoSrc: "assets/video/placeholder-course-intro.mp4", body: "By the end of this journey you'll have built your own working pages and mini projects â€” not just read about them." },
      { heading: "Variables, Types & Data", videoSrc: "assets/video/placeholder-variables-types-data.mp4", body: "Numbers, strings, booleans, and lists â€” the basic 'gear' every Python project uses." },
      { heading: "Conditionals", videoSrc: "assets/video/placeholder-conditionals.mp4", body: "if / elif / else statements are decision points on the trail â€” 'if this happens, do that.'" },
      { heading: "Loops", videoSrc: "assets/video/placeholder-loops.mp4", body: "for and while loops repeat tasks without repeating code â€” like running the same drill over and over." },
      ...
      { heading: "Debugging Basics", videoSrc: "assets/video/placeholder-debugging-basics.mp4", body: "Error messages aren't scary â€” they're clues. Read them top to bottom before panicking." },
  ...
  },
  {
    ...
    cards: [
      ...
      { heading: "APIs", videoSrc: "assets/video/placeholder-apis.mp4", body: "APIs are how a website's frontend asks a Python backend for data â€” like ordering from a menu." },
  ...
  },
  {
    ...
    cards: [
      ...
      { heading: "Safety First", videoSrc: "assets/video/placeholder-safety-first.mp4", body: "Be extra careful with delete commands â€” always test on a copy of your files first." },
  ...
  },
  {
    ...
    theme: "Stadium â€” Big Game Night",
    cards: [
      { heading: "What You'll Learn", videoSrc: "assets/video/placeholder-course-intro.mp4", body: "By the end of this journey you'll have built your own working pages and mini projects â€” not just read about them." },
      { heading: "Icebreaker", videoSrc: "assets/video/placeholder-course-intro.mp4", body: "By the end of this journey you'll have built your own working pages and mini projects â€” not just read about them." },
      { heading: "Helpful Terms to Know", videoSrc: "assets/video/placeholder-course-intro.mp4", body: "By the end of this journey you'll have built your own working pages and mini projects â€” not just read about them." },
      { heading: "Data is Everywhere", videoSrc: "assets/video/placeholder-data-is-everywhere.mp4", body: "Stats, scores, and trends are just numbers waiting to tell a story â€” like a box score after a big game." },
  ...
  },
  {
    ...
    cards: [
      ...
      { heading: "Bias & Limitations", videoSrc: "assets/video/placeholder-bias-limitations.mp4", body: "LLMs learn from human-written data â€” so they can also learn and repeat human biases. Always question the output." },
  ...
  },
  {
    ...
    cards: [
      ...
      { heading: "Icebreaker", videoSrc: "assets/video/placeholder-course-intro.mp4", body: "By the end of this journey you'll have built your own working pages and mini projects â€” not just read about them." },
      { heading: "Helpful Terms to Know", videoSrc: "assets/video/placeholder-course-intro.mp4", body: "By the end of this journey you'll have built your own working pages and mini projects â€” not just read about them." },
      { heading: "How Computers 'See'", videoSrc: "assets/video/placeholder-how-computers-see.mp4", body: "An image is just a grid of numbers (pixels) â€” computer vision is math applied to those grids." },
  ...
  },
  {
    ...
    cards: [
      ...
      { heading: "Icebreaker", videoSrc: "assets/video/placeholder-course-intro.mp4", body: "By the end of this journey you'll have built your own working pages and mini projects â€” not just read about them." },
      { heading: "Helpful Terms to Know", videoSrc: "assets/video/placeholder-course-intro.mp4", body: "By the end of this journey you'll have built your own working pages and mini projects â€” not just read about them." },
      { heading: "Inspired by Brains", videoSrc: "assets/video/placeholder-inspired-by-brains.mp4", body: "Neural networks are made of connected 'neurons' in layers â€” a bit like a constellation of stars linked together." },
      { heading: "How a Neural Net Learns", videoSrc: "assets/video/placeholder-how-a-neural-net-learns.mp4", body: "It takes inputs, makes a guess, checks how wrong it was, and adjusts â€” over and over, thousands of times." },
  ...
  },
  {
    ...
    cards: [
      ...
      { heading: "Icebreaker", videoSrc: "assets/video/placeholder-course-intro.mp4", body: "By the end of this journey you'll have built your own working pages and mini projects â€” not just read about them." },
      { heading: "Helpful Terms to Know", videoSrc: "assets/video/placeholder-course-intro.mp4", body: "By the end of this journey you'll have built your own working pages and mini projects â€” not just read about them." },
      { heading: "Learning by Trial & Reward", videoSrc: "assets/video/placeholder-learning-by-trial-reward.mp4", body: "Reinforcement learning is like leveling up in a video game â€” try something, get a reward or penalty, adjust your strategy." },
      ...
      { heading: "You Reached the Summit", videoSrc: "assets/video/placeholder-you-reached-the-summit.mp4", body: "You've gone from 'what is a website?' to training an AI agent. Look back at the trail â€” that's the whole journey." },
      ...
      { heading: "Recap", videoSrc: "assets/video/placeholder-course-intro.mp4", body: "By the end of this journey you'll have built your own working pages and mini projects â€” not just read about them." },
      { heading: "End of This Road", videoSrc: "assets/video/placeholder-course-intro.mp4", body: "By the end of this journey you'll have built your own working pages and mini projects â€” not just read about them." },
]
  }
];
