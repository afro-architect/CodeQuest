  ...
  },
  {
    ...
    cards: [
      ...
      },
      {
        ...
        videoSrc: "assets/video/L2-remix.mp4",
      ...
      },
{
  ...
  },
  {
    ...
    cards: [
      { heading: "What You'll Learn", videoSrc: "assets/video/placeholder-course-intro.mp4", body: "This stop is all about HTML — how tags label the parts of a page, how they nest inside each other like a cookbook full of recipes, and how you write and run your very first HTML page." },
      { heading: "Icebreaker", videoSrc: "assets/video/placeholder-course-intro.mp4", body: "What's your go-to order when you're hanging with friends — and do you like following a recipe exactly, or improvising as you go? Share both in the discussion tab." },
      { heading: "Helpful Terms to Know", videoSrc: "assets/video/placeholder-course-intro.mp4", body: "Markup language, tag, and element — the three terms you'll be using on every single card from here on out." },
...
// Paste this in place of the existing lesson-4 object (same id) in the top-level array.
  ...
  responsiveBreakpoints: {
    ...
    modes: [
      ...
      { heading: "Mini Project: Design a Storefront Card", videoSrc: "assets/video/placeholder-mini-project-storefront-card.mp4", body: "Time to put it all together. Below is a plain, unstyled storefront card — a shop name, a one-line blurb, a price, and a button — sitting in an empty display case with no decor at all.\n\nUsing everything from this stop — selectors, colors and fonts, spacing, and the box model — style it into a card that actually feels like it belongs in the mall: pick a selector to target the card, add padding and a border so it reads as a proper display case, choose a background color and font for the signage, and give the button its own look so it feels clickable.\n\nThere's no single right answer here — two students can start from the exact same HTML and end up with two completely different-looking storefronts, which is the whole point of CSS.", playground: { lang: "web", code: "<!DOCTYPE html>\n<html>\n  <head>\n    <style>\n      /* Your turn: style .store-card, .store-card h3, .store-card p,\n         .store-card .price, and .store-card button below */\n\n    </style>\n  </head>\n  <body>\n    <div class=\"store-card\">\n      <h3>SoleZone</h3>\n      <p>Fresh sneaker drops, restocked every Friday.</p>\n      <span class=\"price\">$64.99</span>\n      <button>Shop Now</button>\n    </div>\n    <!-- Challenge: use the box model (padding, border, margin) to make this\n         feel like a real display case, then add color, font, and spacing -->\n  </body>\n</html>" } },
      { heading: "Recap", videoSrc: "assets/video/placeholder-course-intro.mp4", body: "HTML is the structure underneath every website: tags label your content, an opening tag + content + closing tag makes an element, and nesting lets you build containers inside containers — all the way down to your very first working HTML page." },
      { heading: "What's Next?", videoSrc: "assets/video/placeholder-course-intro.mp4", body: "By the end of this journey you'll have built your own working pages and mini projects and not just read about them." },
]
  },
