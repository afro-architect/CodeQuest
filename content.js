      ...
      },
{
  ...
  },
  {
    ...
    cards: [
      ...
      { heading: "Icebreaker", videoSrc: "assets/video/placeholder-course-intro.mp4", body: "By the end of this journey you'll have built your own working pages and mini projects and not just read about them." },
      { heading: "Helpful Terms to Know", videoSrc: "assets/video/placeholder-course-intro.mp4", body: "By the end of this journey you'll have built your own working pages and mini projects and not just read about them." },
      { heading: "HTML = The Ingredients", videoSrc: "assets/video/placeholder-html-the-ingredients.mp4", body: "HTML (HyperText Markup Language) is the skeleton of every website you've ever visited — TikTok, YouTube, your school portal, all of it. It's not really a 'programming language' like Python; it's a markup language, meaning its whole job is to label pieces of content so a browser knows what ingredients make up a website. The labels tell the browser what's a heading, what's a paragraph, what's an image, and so on. Think of it like a set of instructions for how to label the ingredients or parts that you combine to make up the internet.\n\nWhy it matters: before you can make a website look cool or do anything interactive, you need something for the styling (CSS) and behavior (JavaScript/Python-backed logic) to attach to. HTML is that foundation — skip it and there's nothing to build on. In your skill progression, HTML is literally step one of 'how the web works,' and everything else (CSS, JavaScript, even backend Python with frameworks like Flask) gets layered on top of it." },
      { heading: "Tags & Elements", videoSrc: "assets/video/placeholder-tags-elements.mp4", body: "Tags are the labels themselves — little instructions wrapped in angle brackets like <code>&lt;p&gt;</code> or <code>&lt;h1&gt;</code> that tell the browser 'this next chunk of content is a paragraph' or 'this is a big heading.'\n\nRelatable way to think about it: it's like to-go food packaging. The tag is the receipt taped on the container telling you what's inside before you open it. <code>&lt;h1&gt;My Robotics Project&lt;/h1&gt;</code> is a tag-wrapped heading.\n\nMost tags come in pairs: an opening tag <code>&lt;p&gt;</code> and a closing tag <code>&lt;/p&gt;</code>, with your actual content sandwiched in between. That whole package — opening tag + content + closing tag — is called an element.\n\nUnderstanding tags/elements is the vocabulary you need before you can read or write any HTML — it's like learning letters before words." },
      {
      ...
      { heading: "Where Python Runs", videoSrc: "assets/video/placeholder-where-python-runs.mp4", body: "Python runs almost anywhere: in a terminal on your own laptop, inside a browser-based tool like this one, on a server you never see, or on tiny devices like a Raspberry Pi. Wherever it runs, the code you write looks exactly the same." },
 {
  ...
  syntaxAnnotate: {
    ...
    outputText: "Reached Ridge Line",
      ...
      { heading: "Python Installation", videoSrc: "assets/video/placeholder-course-intro.mp4", body: "Coming Soon." },   
      {
  ...
  },
  {
    ...
    cards: [
      ...
      { heading: "Print Statements", videoSrc: "assets/video/placeholder-print-input.mp4", body: "print('Hello!') and input('What's your name? ') are your first two Python commands.", playground: { lang: "python", code: "print('Hello!')\nname = 'Explorer'\nprint('What is your name? (edit the name variable above and Run again)')\nprint('Nice to meet you, ' + name + '!')" } },
      ...
      { heading: "Input, Output & Operators", videoSrc: "assets/video/placeholder-variables-types-data.mp4", body: "Python can do math (+, -, *, /) and combine text (+) just like a calculator and a word processor rolled into one.", playground: { lang: "python", code: "trail_miles = 8\nmiles_hiked = 3\n\nprint('Miles left:', trail_miles - miles_hiked)\nprint('Total snacks needed:', trail_miles * 2)\n\nfirst_name = 'Alex'\nlast_name = 'Rivera'\nprint('Hiker: ' + first_name + ' ' + last_name)" } },
      ...
      { heading: "Type Casting", videoSrc: "assets/video/placeholder-print-input.mp4", body: "Type casting helps us work with different data types.", playground: { lang: "python", code: "print('Hello!')\nname = 'Explorer'\nprint('What is your name? (edit the name variable above and Run again)')\nprint('Nice to meet you, ' + name + '!')" } },
      { heading: "Print Formatting", videoSrc: "assets/video/placeholder-print-input.mp4", body: "Formatting helps the output look more presentable and easier to read.", playground: { lang: "python", code: "print('Hello!')\nname = 'Explorer'\nprint('What is your name? (edit the name variable above and Run again)')\nprint('Nice to meet you, ' + name + '!')" } },
      ...
      { heading: "Decision-Making Statements", videoSrc: "assets/video/placeholder-conditionals.mp4", body: "if / elif / else statements are decision points on the trail and 'if this happens, do that.'", playground: { lang: "python", code: "water_bottles = 1\n\nif water_bottles == 0:\n    print('Fill up before you go!')\nelif water_bottles < 2:\n    print('You might want one more bottle.')\nelse:\n    print(\"You're set on water.\")" } },
      ...
      { heading: "Functions", videoSrc: "assets/video/placeholder-functions-imports.mp4", body: "Functions package reusable code.", playground: { lang: "python", code: "import random\n\ndef pack_snack():\n    snacks = ['trail mix', 'granola bar', 'apple', 'jerky']\n    return random.choice(snacks)\n\nprint(\"Today's snack:\", pack_snack())\nprint(\"Today's snack:\", pack_snack())" } },
      { heading: "Mini Challenge: TBD", videoSrc: "assets/video/placeholder-mini-challenge-say-hello.mp4", body: "Coming Soon.", playground: { lang: "python", code: "name = 'Explorer'\n\ndef greet(who):\n    print('Hey there, ' + who + '! Welcome to the trail.')\n\ngreet(name)" } },
      ...
      { heading: "Imports", videoSrc: "assets/video/placeholder-functions-imports.mp4", body: "Imports let you bring in tools other people already built.", playground: { lang: "python", code: "import random\n\ndef pack_snack():\n    snacks = ['trail mix', 'granola bar', 'apple', 'jerky']\n    return random.choice(snacks)\n\nprint(\"Today's snack:\", pack_snack())\nprint(\"Today's snack:\", pack_snack())" } },
