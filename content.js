...
const LESSON_CONTENT = [
  ...
  },
  {
    ...
    cards: [
      ...
      { heading: "Navigation Bars", videoSrc: "assets/video/placeholder-navigation-bars.mp4", body: "Menus let people move around a site without getting lost and like signs pointing to the ramps and rails at a skate park." },
  ...
  },
  {
    ...
    cards: [
      ...
      { heading: "Selectors", videoSrc: "assets/video/placeholder-selectors.mp4", body: "You can target elements by tag, class, or id and like picking an outfit for everyone vs. picking one just for you." },
      ...
      { heading: "The Box Model", videoSrc: "assets/video/placeholder-the-box-model.mp4", body: "Every element is a box: content, padding, border, margin and like layers of packaging around a product." },
  ...
  },
  {
    ...
    cards: [
      ...
      { heading: "Icebreaker", videoSrc: "assets/video/placeholder-course-intro.mp4", body: "By the end of this journey you'll have built your own working pages and mini projects and not just read about them." },
      { heading: "Helpful Terms to Know", videoSrc: "assets/video/placeholder-course-intro.mp4", body: "By the end of this journey you'll have built your own working pages and mini projects and not just read about them." },
      { heading: "JS = The Controller", videoSrc: "assets/video/placeholder-js-the-controller.mp4", body: "JavaScript makes a page interactive and it responds to clicks, typing, and time." },
      ...
      { heading: "Events", videoSrc: "assets/video/placeholder-events.mp4", body: "Clicks, hovers, and form submits are 'events' and triggers that make something happen." },
      { heading: "Functions", videoSrc: "assets/video/placeholder-functions.mp4", body: "Functions are reusable blocks of instructions and your character's 'combo move' you can call anytime." },
