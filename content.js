      ...
      },
{
  ...
  responsiveBreakpoints: {
    ...
    instructions: "Same skate shop page, three screen widths. Switch tabs, then compare the plain preview on the left with the callouts on the right to see exactly what rearranges at each breakpoint â€” no code here yet, just watch the page change.",
    ...
    modes: [
      {
        ...
        changes: [],
        emptyChangeNote: "This is the starting point â€” the full-width layout. Switch to Tablet or Mobile to see what changes.",
      ...
      },
      {
        ...
        changes: [
          "1. The hero switches from a side-by-side row to a stacked column â€” the text centers itself above the skateboard icon."
        ],
  ...
  },
  {
    ...
    cards: [
      ...
      { heading: "HTML = The Ingredients", videoSrc: "assets/video/placeholder-html-the-ingredients.mp4", body: "HTML (HyperText Markup Language) is the skeleton of every website you've ever visited â€” TikTok, YouTube, your school portal, all of it. It's not really a \"programming language\" like Python; it's a markup language, meaning its whole job is to label pieces of content so a browser knows what ingredients make up a website. The labels tell the browser what's a heading, what's a paragraph, what's an image, and so on. Think of it like a set of instructions for how to label the ingredients or parts that you combine to make up the internet.\n\nWhy it matters: before you can make a website look cool or do anything interactive, you need something for the styling (CSS) and behavior (JavaScript/Python-backed logic) to attach to, like the bones of a meat based dish.\n\nHTML is that foundation â€” skip it and there's nothing to build on. In your skill progression, HTML is literally step one of \"how the web works,\" and everything else (CSS, JavaScript, even backend Python with frameworks like Flask) gets layered on top of it." },
      { heading: "Tags & Elements", videoSrc: "assets/video/placeholder-tags-elements.mp4", body: "Tags are the labels themselves â€” little instructions wrapped in angle brackets like <p> or <h1> that tell the browser \"this next chunk of content is a paragraph\" or \"this is a big heading.\"\n\nRelatable way to think about it: it's like to-go food packaging. The tag is the receipt taped on the container telling you what's inside before you open it. <h1>My Robotics Project</h1> is a tag-wrapped heading.\n\nMost tags come in pairs: an opening tag <p> and a closing tag </p>, with your actual content sandwiched in between. That whole package â€” opening tag + content + closing tag â€” is called an element.\n\nUnderstanding tags and elements is the vocabulary you need before you can read or write any HTML â€” it's like learning letters before words." },
      {
        heading: "Activity: Match the Code to the Page",
        videoSrc: "assets/video/placeholder-tags-elements.mp4",
        body: "On the left is a real sample IDE with HTML for a snack truck's page. On the right is that exact page, rendered live. Hover either side to see how a line of code and a part of the real page connect. Then click a line of code and click the part of the site you think it produced (or start from the site â€” either order works) to match them up. Match all 5 to finish.",
        ideSiteMatch: {
          filename: "index.html",
          instructions: "Hover either panel to see how a line of code and a part of the real page connect. Click a line of code, then click the part of the site you think it produced â€” or start from the site, either order works â€” to match them up.",
          codeLines: [
          ...
          siteHtml:
            ...
            "</div>",
          pairs: [
            { id: "h1", selector: ".tem-h1", label: "Heading (<h1>)", job: "The biggest, most important text on the page â€” used once per page." },
            { id: "p", selector: ".tem-p", label: "Paragraph (<p>)", job: "Holds a block of regular sentence text." },
            { id: "a", selector: ".tem-link", label: "Link (<a>)", job: "Takes the visitor somewhere else when clicked â€” another page, section, or site." },
      ...
      { heading: "The IDE", videoSrc: "assets/video/placeholder-tags-elements.mp4", body: "IDE stands for Integrated Development Environment â€” basically a supercharged text editor built for writing code (think VS Code, Replit, or CodePen). Regular apps like Google Docs auto-correct and format things for humans to read; an IDE is built for code â€” it highlights syntax in colors, catches typos and errors, auto-completes tags, and lets you preview your site instantly.\n\nRelatable way to think about it: if HTML is the ingredients, the IDE is your kitchen â€” the counter space, knives, and stove that make cooking actually possible.\n\nYou could technically write HTML in Notepad, but it'd be like chopping vegetables with a butter knife on your lap. Getting comfortable in an IDE early pays off across every future project â€” the same skills (running code, reading error messages, organizing files) carry straight into Python, JavaScript, or Arduino work." },
      { heading: "Text & Content Tags", videoSrc: "assets/video/placeholder-tags-elements.mp4", body: "These are the tags that handle the actual words and content people read: <h1> through <h6> for headings (big to small), <p> for paragraphs, <strong> for bold or important text, <em> for emphasis and italics, and <span> for small inline bits you want to style differently.\n\nRelatable way to think about it: it's like formatting a group chat message or a school essay â€” some words need to be a title, some need emphasis, some are just regular text. These tags let you organize information the way your brain naturally organizes it, which is huge for accessibility too â€” screen readers use these tags to know what to read as a heading versus regular text.\n\nThis is the \"readability and communication\" layer of your web skills â€” the same instinct you use when designing a clear lesson slide." },
      { heading: "List & Table Tags", videoSrc: "assets/video/placeholder-tags-elements.mp4", body: "Lists (<ul> for bullet points, <ol> for numbered lists, <li> for each list item) and tables (<table>, <tr> for rows, <td> for cells) let you organize information into structured groups instead of one giant wall of text.\n\nRelatable way to think about it: like making a packing list for a trip (unordered list), a top-10 ranking (ordered list), or a class schedule grid (table). If you've ever built a spreadsheet or a schedule, you already think in this structure â€” HTML just gives it browser-readable form.\n\nThis connects directly to data organization skills you'd use later in Python too, like when you work with lists and dictionaries." },
      ...
      { heading: "Containers & Sections", videoSrc: "assets/video/placeholder-tags-elements.mp4", body: "Tags like <div> and <section> (plus <header>, <footer>, <nav>, <article>) don't display any content themselves â€” they're invisible boxes that group related stuff together so you can style or position it as one unit.\n\nRelatable way to think about it: imagine organizing your backpack â€” you don't just throw everything in loose, you use pockets and pouches (pencil pouch, laptop sleeve, snack pocket). Containers are those pouches for your webpage's content.\n\nThis becomes essential the moment you start using CSS, because almost all layout and styling techniques (like Flexbox or Grid) work by targeting containers, not individual pieces of text." },      
  {
  heading: "HTML Comments",
  videoSrc: "assets/video/placeholder-tags-elements.mp4",
  body: "Comments look like <!-- this is a comment --> and the browser completely ignores them â€” they're notes left in the code purely for humans (you, or teammates) to read.\n\nRelatable way to think about it: it's like sticky notes on a group project poster â€” reminders like \"finish this section\" or \"don't delete this yet, testing something.\"\n\nEvery language you'll ever code in (Python uses #, JavaScript uses //) has some version of comments, so building the habit of leaving clear notes now makes you a much easier collaborator later, whether that's a classmate or your future self debugging at midnight.\n\nAn HTML comment is made from an opening comment marker, a note in the middle, and a closing comment marker. Explore each piece below to see how the browser knows where the hidden note starts and stops.",
  syntaxAnnotate: {
    language: "HTML",
    filename: "index.html",
    lines: [
    ...
    outputText: "Visible result: this line does not display anything on the page."
      ...
      { heading: "Layout Tags", videoSrc: "assets/video/placeholder-tags-elements.mp4", body: "These are the structural tags â€” <header>, <nav>, <main>, <footer>, <section> â€” that define the major regions of a page: the top banner, the navigation menu, the main content, the bottom info bar.\n\nRelatable way to think about it: think of a magazine or a YouTube page layout â€” there's always a header up top, a sidebar or nav for browsing, the main video or article in the middle, and footer info at the bottom. Once you know these tags, you start \"seeing\" the skeleton underneath every website you visit.\n\nThis is a big step toward thinking like a designer, not just a coder â€” it's the bridge between HTML structure and real UI/UX design decisions." },
      { heading: "Nesting", videoSrc: "assets/video/placeholder-nesting.mp4", body: "Nesting means putting elements inside other elements â€” like an <li> inside a <ul>, or a <p> inside a <div>. The trick is that tags have to open and close in the right order, like Russian nesting dolls: whatever opens last has to close first.\n\nRelatable way to think about it: it's exactly like folders inside folders on your computer, or a playlist inside a playlist folder inside your music app.\n\nGetting nesting right is one of the most common early debugging challenges â€” a missing closing tag can make your whole layout break. This is also great practice for coding logic in general, since nesting (loops inside loops, if-statements inside functions) shows up constantly once you move into Python." },
      {
      ...
      { heading: "Link & Media Assets", videoSrc: "assets/video/placeholder-tags-elements.mp4", body: "The <a> tag creates clickable links, like <a href=\"https://example.com\">click me</a>, while <img>, <video>, and <audio> tags embed pictures, videos, and sound directly into the page.\n\nRelatable way to think about it: this is the \"connect the dots\" layer of the web â€” links are literally what makes it a web, weaving separate pages together, and media tags are what turn a plain text document into something that feels alive, like adding your 3D print photos or a demo video of your robot in action to a project page.\n\nThis is often the most exciting tag group for beginners because it's the difference between \"a page of text\" and \"a real website\" â€” and it sets you up for later skills like optimizing image file sizes or embedding interactive content (like a Scratch project or a p5.js sketch) inside your site." },      
...
// Paste this in place of the existing lesson-4 object (same id) in the top-level array.

  {
    ...
    cards: [
      ...
      { heading: "Helpful Terms to Know", videoSrc: "assets/video/placeholder-course-intro.mp4", body: "A short glossary of words youâ€™ll see a lot in this courseâ€”like HTML, CSS, JavaScript, element, and browserâ€”so the rest of the lessons feel more familiar." },
      { heading: "What is CSS?", videoSrc: "assets/video/placeholder-css-the-outfit.mp4", body: "CSS (Cascading Style Sheets) is what makes a website go from \"plain text on a white page\" to actually looking like something \u2014 colors, fonts, spacing, layout, all of it. If HTML is the skeleton, CSS is the skin, clothes, and style. Same content, totally different vibe depending on the CSS.\n\nRelatable way to think about it: think about how the same essay looks completely different depending on the font and formatting \u2014 Comic Sans vs. a clean sans-serif, cramped vs. spaced out. CSS is you controlling that, on purpose, for every element on the page.\n\nIn your skill progression, CSS is the layer where coding starts feeling like design \u2014 it's where you go from \"does this work\" to \"does this look good,\" which is a totally different (and honestly harder) skill than HTML alone." },
        ...
        cssWhereLives: {
          instructions: "Same heading, same final look, three different places to write the CSS. Switch tabs to compare â€” the rendered result below never changes.",
          modes: [
            {
              key: "inline",
              label: "Inline",
              ...
              caption: "Written directly on the element with the style attribute. Fastest for a one-off tweak, but it only affects this exact tag â€” copy the tag somewhere else and the style doesn't come with it.",
            },
            {
              key: "internal",
            ...
            },
            {
              ...
              caption: "Lives in its own .css file, linked once with <link>. Every page that links to styles.css shares the same rule â€” this is what real, multi-page projects use almost all the time.",
            },
          ],
          preview: [
          ...
          ideCaption: "Same three approaches, real tool â€” here they all live together in one file so you can see them side by side. Click Run, then try changing the inline color above and the .storefront color in the style block.",
        },
...
// Paste each block in place of its matching lesson object (same id) in the top-level array.
  ...
  },
  {
    ...
    cards: [
      { heading: "What You'll Learn", videoSrc: "assets/video/placeholder-course-intro.mp4", body: "By the end of this journey you'll have built your own working pages and mini projects and not just read about them." },
      { heading: "Icebreaker", videoSrc: "assets/video/placeholder-course-intro.mp4", body: "Name one app or website you use every day. Instagram, Spotify, and Netflix all run Python behind the scenes â€” what do you think it might be doing back there?" },
      ...
      { heading: "Where Python Runs", videoSrc: "assets/video/placeholder-where-python-runs.mp4", body: "Python runs almost anywhere: your own laptop (Mac, Windows, Linux) once installed, cloud-based coding platforms in a browser tab like Replit or Google Colab with no install needed, servers that power websites, and even tiny microcontrollers via MicroPython.\n\nRelatable way to think about it: Python doesn't need one special beach \u2014 you can paddle out anywhere as long as you've got your board. Your laptop is your local home beach. A browser-based tool like Replit is like renting a board at a beach you're just visiting, no gear required. And something like a Raspberry Pi running Python is like a tiny travel board that still lets you catch small waves anywhere you go.\n\nThis flexibility is a big reason Python became so popular \u2014 you're never locked into one setup." },
 {
    ...
    outputText: "Reached Ridge Line",
...
},
      {
        ...
        matchActivity: {
          ...
          options: [
            { key: "colon", label: "Colon (:) â€” announces a new indented block is coming", shortLabel: "Colon", previewColor: "#2a6df5" },
            { key: "indent", label: "Indentation â€” spaces showing this line lives inside the block above", shortLabel: "Indentation", previewColor: "#0f9d58" },
            { key: "noSemicolon", label: "No semicolon needed â€” Python lines just end with a line break", shortLabel: "No semicolon", previewColor: "#caa000" },
          ],
          hints: {
            colon: "Look for the punctuation mark right before the line ends â€” it's Python's signal that an indented block follows.",
            indent: "Count the spaces before the code starts â€” that whitespace is what tells Python this line belongs inside something else.",
  ...
  },
  {
    ...
    cards: [
      ...
      { heading: "Activity: The Echo", videoSrc: "assets/video/placeholder-course-intro.mp4", body: "The very first \"aha\" moment in backend work: sending something across the line and getting the exact same thing back, proving Python is actually listening on the other end.\n\nRelatable way to think about it: it's like yelling across a canyon and hearing your own voice come back. Nothing clever happens yet â€” you're just confirming the line works.", playground: {"lang": "python", "code": "def echo(message):\n    # A real endpoint would receive this over the network.\n    # For now, call it directly and watch it come straight back.\n    return message\n\nsent = \"Can you hear me, Python?\"\nreceived = echo(sent)\n\nprint(\"Frontend sent:\", sent)\nprint(\"Backend echoed back:\", received)"} },
      { heading: "Frontend vs. Backend: The Real Separation of Powers", videoSrc: "assets/video/placeholder-frontend-vs-backend.mp4", body: "You already know the frontend â€” the part people see and touch. The backend is the part that thinks.\n\nFrontend (JavaScript):\n\n- Buttons\n- Forms\n- Camera input\n- Displaying results\n- Animations\n\nBackend (Python):\n\n- Logic\n- AI\n- Data processing\n- API calls\n- File handling\n\nRelatable way to think about it: frontend is the platform you're standing on, backend is the platform on the other side of the line. JavaScript sends a request across, Python processes it, Python sends a response back, and JavaScript updates what you see. Neither platform tries to do the other one's job." },
      { heading: "Activity: The Decision Maker", videoSrc: "assets/video/placeholder-course-intro.mp4", body: "Now make Python do something the browser genuinely can't: decide something on its own, differently each time.\n\nRelatable way to think about it: press a button on the frontend platform, and whatever comes back across the line is entirely up to the backend â€” the browser has no idea what answer is coming until it arrives.", playground: {"lang": "python", "code": "import random\n\ndef ask_the_brain():\n    answers = ['Yes', 'No', 'Maybe', 'Try again']\n    return random.choice(answers)\n\n# Simulate pressing \"Ask the Brain\" three times\nfor _ in range(3):\n    print('Frontend asks... Backend says:', ask_the_brain())"} },
      { heading: "APIs: Your Zipline to the Outside World", videoSrc: "assets/video/placeholder-apis.mp4", body: "So far, every response you've built comes from your own Python logic. An API lets your backend platform ask a completely different platform for help â€” one you didn't build and don't control.\n\nWhat calling an API actually takes:\n\n- Send a request to someone else's server, usually with the `requests` library\n- Read the JSON response that comes back\n- Pull out the piece you actually need\n- Send that piece back to your own frontend\n\nMini example: your website sends \"Translate: I love robotics.\" Python calls a translation API. The API responds with \"Me encanta la robÃ³tica.\" Your website displays it instantly â€” three platforms, one smooth trip.\n\nThe same shape works for pulling in weather data, movie recommendations, or almost any live information you don't want to hand-type yourself." },
      { heading: "Activity: The Translator", videoSrc: "assets/video/placeholder-course-intro.mp4", body: "Same shape as everything else on this stop â€” send something out, get something back â€” except now the \"brain\" answering is a real translation service somewhere else on the internet.\n\nThis one needs a live network connection and a real API key, so it can't safely run inside this browser sandbox. Here's exactly what the code looks like when it's running for real:", playground: {"lang": "python", "code": "import requests\n\ndef translate(text, target_language='es'):\n    response = requests.post(\n        'https://api.example.com/translate',\n        json={'text': text, 'target': target_language},\n        headers={'Authorization': 'Bearer YOUR_API_KEY'}\n    )\n    return response.json()['translated_text']\n\nprint(translate('I love robotics'))", "unsupported": true, "reason": "This example needs a real API key and a live network call, which can't run safely in this browser sandbox."} },
      { heading: "Pretrained Models: The AI Shortcut", videoSrc: "assets/video/placeholder-course-intro.mp4", body: "APIs aren't the only way to borrow intelligence â€” you can also load a pretrained model directly into your own Python code and run it yourself, no external service required.\n\nTools like HuggingFace, OpenCV, and MediaPipe give you models that already know how to classify text, detect faces, or track hand movement, all trained by someone else on huge amounts of data.\n\nYou won't train a model on this trail. You'll learn to load one and ask it questions â€” and you'll get real hands-on practice with this exact skill soon: language models at Chatbot Alley, and computer vision at Photo Booth." },
      { heading: "The Request â†’ Process â†’ Response Loop", videoSrc: "assets/video/placeholder-course-intro.mp4", body: "This is the one pattern behind every single thing you'll build from here on:\n\n1. Frontend sends data\n2. Python receives it\n3. Python runs logic or AI\n4. Python returns JSON\n5. Frontend updates the page\n\nMaster this loop, and you can build a chatbot, a camera app, a recommendation engine, an accessibility tool, or a study helper â€” they're all the exact same five steps, just with different logic sitting in step 3." },
      { heading: "Activity: The Text Analyzer", videoSrc: "assets/video/placeholder-course-intro.mp4", body: "Run the whole loop end to end: send text over, let Python actually process it, and get real structured results back â€” not just an echo this time.", playground: {"lang": "python", "code": "def analyze_text(sentence):\n    words = sentence.split()\n    longest = max(words, key=len)\n    return {\n        'word_count': len(words),\n        'character_count': len(sentence),\n        'longest_word': longest\n    }\n\nsent = \"Python powers the web behind the scenes\"\nresult = analyze_text(sent)\n\nprint('Frontend sent:', sent)\nprint('Backend analyzed it:', result)"} },
      { heading: "Where This Loop Takes You", videoSrc: "assets/video/placeholder-course-intro.mp4", body: "Once you can run this loop with your eyes closed, whole categories of projects open up. A few you'll be ready to build once you've picked up a bit more Python and AI further down the trail:\n\n- AI Study Buddy â€” send a homework question, get back an explanation from an LLM\n- Mood-Based Playlist Generator â€” send how you're feeling, get back a matching playlist\n- Food Recognition Camera â€” send a photo, get back what's in it\n- Accessibility Tool â€” send an image, get back a description of it\n\nEvery one of these is the exact same five-step loop you just learned, wearing a different outfit. You'll build toward one of these, or something entirely your own, at the Summit." },
      { heading: "Fork This Starter Project â†’", videoSrc: "assets/video/placeholder-fork-this-starter-project.mp4", body: "Fork the mini backend starter â€” an Echo and Decision Maker endpoint already wired up â€” and add one endpoint of your own that does something nobody's tried yet.", forkLink: "REPLACE_WITH_STARTER_REPO_LINK" },
      { heading: "Recap", videoSrc: "assets/video/placeholder-course-intro.mp4", body: "Python is the brain behind the site. It receives requests, does the thinking â€” logic, AI, an API call â€” and sends a response back across the line. Every backend feature you'll ever build is that same loop, on repeat." },
  ...
  },
  {
    ...
    cards: [
      ...
      { heading: "The Build Sprint", videoSrc: "assets/video/placeholder-course-intro.mp4", body: "Getting from idea to working demo follows the same steps every time, no matter which category you picked:\n\n- Scoping â€” decide exactly what your app does, and just as importantly, what it doesn't\n- Wireframing â€” sketch what the frontend looks like before you build it\n- Building endpoints â€” write the Python that actually does the work\n- Connecting frontend â€” wire your JS up to call those endpoints and show what comes back\n- Testing â€” try to break your own app before anyone else does\n- Polishing â€” the last pass that makes it feel finished, not just functional\n\nThis is the exact same checklist real teams use before shipping anything." },
